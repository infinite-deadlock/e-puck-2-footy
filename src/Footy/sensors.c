...
static void detection_in_image(uint8_t * red_pixels, uint8_t * green_pixels, uint8_t * blue_pixels);
...
static void analyze_image(void)
{
	...
	static uint8_t   blue_pixels[IMAGE_BUFFER_SIZE] = {0};
    ...
    for(uint16_t i = 0, j; i < 2 * IMAGE_BUFFER_SIZE ; i += 2)
    {
    	...
    	blue_pixels[j] = img_raw_RGB565_pixels[i + 1] & 31;
    }
...
static bool check_ball_presence_with_lookup(uint8_t r, uint8_t g, uint8_t b)
{
