...
bool check_ball_presence_with_lookup(uint8_t r, uint8_t g, uint8_t b)
{
    static const bool lookup_check_ball_presence[NB_COLORS] = {
...
void detection_in_image(uint8_t * red_pixels, uint8_t * green_pixels, uint8_t * blue_pixels)
{
    ...
    {
        assert(check_ball_presence_with_lookup(red_pixels[i], green_pixels[i], blue_pixels[i]) == check_ball_presence(red_pixels[i], green_pixels[i], blue_pixels[i]));
...
void launch_detection_in_image(vector<uint16_t> & image)
{
    ...
    detection_in_image(red_pixels, green_pixels, blue_pixels);
}
